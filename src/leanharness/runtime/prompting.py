...
def system_prompt(
    ...
    *,
    ...
    return (
        ...
        "When the active request asks what happened earlier, use the bounded PUBLIC HISTORY "
        "records in the answer; a fresh workspace observation may supplement that history but "
        "must not replace the conversation summary. "
